...
**Basic Usage**
```
┌─[Mantis@HackBox] - [~/Tools/GoKeyBruter] - [2017-07-09 05:06:40]
└─[2] python ~/Tools/GoKeyBruter/GoKeyBuster.py -g ~/GoProgs/bin/gokey -r google.com -p 6n,_Da5WYv -w /home/Mantis/Tools/SecLists/Passwords/top_shortlist.txt 
[+] Found the master password! - test
```

**Setting the Verbosity Level**
```
┌─[Mantis@HackBox] - [~/Tools/GoKeyBruter] - [2017-07-09 05:06:49]
└─[0] python ~/Tools/GoKeyBruter/GoKeyBuster.py -g ~/GoProgs/bin/gokey -r google.com -p 6n,_Da5WYv -w /home/Mantis/Tools/SecLists/Passwords/top_shortlist.txt  -v1
